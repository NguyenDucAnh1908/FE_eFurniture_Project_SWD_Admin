        ...
        <div className="h-100" id="leftside-menu-container" data-simplebar>
          ...
          <ul className="side-nav">
            ...
            <li className="side-nav-item">
              <a
                data-bs-toggle="collapse"
                href="#sidebarProjectBooking"
                aria-expanded="false"
                aria-controls="sidebarProjectBooking"
                className="side-nav-link"
              >
                <i className="uil-folder-plus" />{" "}
                {/* Đây là biểu tượng, bạn có thể thay đổi nếu muốn */}
                <span> Project Booking </span>
                <span className="menu-arrow" />
              </a>
              <div className="collapse" id="sidebarProjectBooking">
                <ul className="side-nav-second-level">
                  <li>
                    <a href="/view-project-booking">View Booking Project</a>
                  </li>
                  <li>
                    <a href="/create-project-booking">Add Booking Project</a>
                  </li>
                </ul>
              </div>
            </li>
