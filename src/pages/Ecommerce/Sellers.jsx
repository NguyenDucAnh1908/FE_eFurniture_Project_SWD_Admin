...
const Sellers = () => {
  ...
  const fetchSeller = async () => {
    try {
      const response = await axios.get(`http://localhost:8080/api/v1/get-all-staff`, {
        params: {
          page: currentPage - 1, // trang hiện tại
          limit: limit // số lượng mục trên mỗi trang
        }
      });
      setSellers(response.data.userResponses);
                                ...
                                return (
                                  <tr key={index}>
                                    ...
                                    <td className="table-user">
                                      ...
                                      <a href="javascript:void(0);" className="text-body fw-semibold">{sellersItem.fullName}</a>
                                    </td>
                                    <td>
                                      {sellersItem.phoneNumber}
                                    </td>
                                    <td>
                                      {sellersItem.email}
                                    </td>
                                    ...
                                    <td>
                                      {sellersItem.dateOfBirth}
                                    </td>
                                    <td>
                                      <span className="badge badge-success-lighten">{sellersItem.active ? 'active' : ''}</span>
                                    </td>
                                    <td>
