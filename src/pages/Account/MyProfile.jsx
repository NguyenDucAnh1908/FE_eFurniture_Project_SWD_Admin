...
const MyProfile = () => {
    ...
    const fetchUserDetail = async () => {
        try {
            ...
            console.log("Check user detail: ", res.data);
        } catch (error) {
                            ...
                            <div className="col-lg-4">
                                <div className="card mb-4">
                                    <div className="card-body text-center">
                                        ...
                                        <h5 className="my-3">{userDetail.fullName}</h5>
                                        <p className="text-muted mb-1">{userDetail.role}</p>
                                    ...
                                    <div className="card-body">
                                        <div className="row">
                                            ...
                                            <div className="col-sm-9">
                                                <p className="text-muted mb-0">{userDetail.fullName}</p>
                                            </div>
                                        </div>
                                        <hr />
                                        <div className="row">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-sm-9">
                                                <p className="text-muted mb-0">{userDetail.phoneNumber}</p>
                                            </div>
                                        </div>
                                        <hr />
                                        <div className="row">
